            ...
            <div class="row">
              ...
              <div class="col-lg-5">
                <section class="widget widget_rhye_cta">
                  <!-- header -->
                  <h2 class="h3 mt-0 mb-0-5">Think it! We Build it!!</h2>
                  <!-- - header -->
                  <!-- button --><a class="button button_solid button_black mb-0-5" data-hover="Get in Touch" href="page-inner-contacts-1.php"><span class="button__label-hover">Get in Touch</span></a>
                  <!-- - button -->
                </section>
              </div>
              <!-- - call to action -->
                ...
                <div class="row justify-content-lg-between">
                  ...
                  <div class="col-lg-3 col-sm-6 col-12">
                    <section class="widget widget_nav_menu">
                      ...
                      <li><a href="project-details-1-fullscreen-center.php">Agrocentric</a>
                        </li>
                        <li><a href="project-details-2-bottom-center.php">build -innovate</a>
                        </li>
                        <!-- <li><a href="project-details-3-halfscreen-left-right.php">Cassio Apartment</a>
                        </li>
                        <li><a href="project-details-4-halfscreen-left-left.php">Nothern Wave</a>
                        </li>
                        <li><a href="project-details-5-bottom-container-center.php">On the Edge</a>
                        </li>
                        <li><a href="project-details-6-bottom-fullwidth.php">Paysage Fiction</a>
                        </li>
                        <li><a href="project-details-7-fullscreen-left.php">Silence &amp; Noise</a>
                        </li> -->
                      </ul>
                      <!-- - content -->
                    </section>
                  ...
                  <div class="col-lg-3 col-sm-6 col-12">
                    <section class="widget widget_nav_menu">
                      ...
                      <ul class="menu js-menu">
                         ...
                         <li><a href="project-details-11-fullscreen-center.php">Goal Travel</a>
                        </li>
                        <li><a href="project-details-12-bottom-container-center.php">Ladre Farm</a>
                        </li>
                        <!-- <li><a href="project-details-12-bottom-container-center.php">The Silent Listener</a>
                        </li>
                        <li><a href="project-details-13-bottom-container-center.php">Arrigo Casual Accessories</a>
                        </li> -->
                      </ul>
                      <!-- - content -->
                    </section>
                  ...
                  <div class="col-lg-3 col-sm-6 col-12">
                    <section class="widget widget_nav_menu">
                      ...
                      <ul class="menu js-menu">
                        ...
                        <li><a href="#">Virtual assistant</a>
                        </li>
                        <li><a href="#">ANALYTICS & BIG DATA</a>
                        </li>
                      </ul>
                      <!-- - content -->
                    </section>
                  ...
                  <div class="col-lg-3 col-sm-6 col-12">
                    <section class="widget widget_nav_menu">
                      ...
                      <!-- content -->
                      <ul class="menu js-menu">
                        <li><a href="page-inner-services-2.php">Services</a>
                        </li>
                        <li><a href="page-inner-about-2.php">About</a>
                        </li>
                        <li><a href="blog-grid-2-columns-sidebar.php">Blog</a>
                        </li>
                        <li><a href="page-inner-contacts-2.php">Contacts</a>
                        </li>
                      </ul>
                      <!-- - content -->
                    </section>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-lg-3 footer__column text-center text-lg-left order-lg-1">
                <section class="widget widget_rhye_logo">
                  <!-- content --><a class="logo" href="index.php" target="_blank">
                    <div class="logo__wrapper-img">
                      <!-- primary logo version (for light backgrounds)--><img class="logo__img-primary" src="img/ci2.png" style="width: 10%;" alt="Capri Digital Media" height="20"/>
                      <!-- secondary logo version (for dark backgrounds)--><img class="logo__img-secondary" src="img/ci.png" style="width: 10%;" alt="Capri Digital Media" height="20"/>
                    </div></a>
                  <!-- - content -->
                </section>
              </div>
              ...
              <div class="col-lg-6 footer__column text-center text-lg-center order-lg-2">
                <section class="widget widget_text">
                  ...
                  <div class="textwidget">
                    <p><small>© 2019 capri Digital Media –Innovate, create, experience IT.. Crafted by <a href="https://capridigitalmedia.com" target="_blank">Capri Team</a></small></p>
                  </div>
                  <!-- - content -->
                </section>
              </div>
