          ...
          <section class="section section-fullheight section-projects section-projects-slider bg-dark-1 overflow" data-arts-theme-text="light" data-arts-os-animation>
            <div class="section-fullheight__inner section-fullheight__inner_mobile text-center">
              <div class="slider slider-fullscreen-projects js-slider-fullscreen-projects js-slider">
                ...
                <!-- - slider CONTENT -->
                <!-- slider IMAGES -->
                <div class="slider-fullscreen-projects__images swiper-container js-slider-fullscreen-projects__images" data-mousewheel-enabled="data-mousewheel-enabled" data-direction="vertical" data-transition-effect="distortion" data-aspect-ratio="1.5" data-transition-displacement-img="img/general/bg-displacement-7.jpg" data-speed="1200" data-autoplay-enabled="true" data-autoplay-delay="6000" data-counter-style="roman">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">
                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/agro3.png"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">
                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/build1.png"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">
                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/goaltravel3.PNG"></div>
                      </div>
                    </div>
                    <div class="swiper-slide overflow">
                      <div class="slider__images-slide-inner js-transition-img overflow" data-swiper-parallax="90%" data-swiper-parallax-opacity="0">
                        <div class="slider__bg lazy-bg js-transition-img__transformed-el" data-texture-src="img/ladrefarm2.png"></div>
                      </div>
                    </div>
                  </div>
                  <!-- overlay-->
                ...
                <!-- <div class="slider-fullscreen-projects__footer swiper-container js-slider-fullscreen-projects__footer">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-3-halfscreen-left-right.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover"></span></a>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-4-halfscreen-left-left.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover"></span></a>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-6-bottom-fullwidth.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover"></span></a>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="slider__wrapper-button-footer"><a class="button button_white button_bordered" data-hover="Explore Project" href="project-details-7-fullscreen-left.html" data-pjax-link="fullscreenSlider"><span class="button__label-hover"></span></a>
                      </div>
                    </div>
                  </div>
                </div> -->
